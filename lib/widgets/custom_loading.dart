...
class ColorLoader2State extends State<ColorLoader2> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation3 = Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
        parent: controller3, curve: const Interval(0.0, 1.0, curve: Curves.decelerate)));
